...
| **\#3: Code that doesn't work** | The AI lacks environmental awareness and operates without sufficient feedback loops. | **Tip \#3: Provide the AI with strict feedback mechanisms:** static typing (e.g., TypeScript), browser access, and automated tests. |
